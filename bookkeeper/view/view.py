...
class View:
    ...
    def set_exp_adder(self, handler: callable) -> None:
        """ Устанавливает метод добавления траты """
        self.exp_adder = handle_error(self.main_window, handler)

    def set_exp_deleter(self, handler: callable) -> None:
    ...
    def set_bdg_modifier(self, handler: callable) -> None:
